...
class BrowserView:
    ...
    class BrowserForm(WinForms.Form):
        def __init__(self, window, cache_dir):
            ...
            # 在访问 Handle（触发窗口创建）前设置 BackColor，避免白色闪屏
            ...
            try:
                ex = windll.user32.GetWindowLongW(self.Handle.ToInt32(), -20)
                windll.user32.SetWindowLongW(self.Handle.ToInt32(), -20, ex | 0x2000000)
            except Exception:
                pass
