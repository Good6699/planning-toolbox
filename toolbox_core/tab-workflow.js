  ...
  function _wfModalFields(type, step) {
    ...
    const m = {
      ...
      error_code_entry: `
        ...
        <div class="form-group"><label>录入语言</label><input type="text" class="wf-modal-input" id="wf_m_ece_lang" data-key="lang_codes" value="${v("lang_codes")}" placeholder="输入语言代码，多个用逗号分隔，留空录入全部匹配语言"></div>`,
    };
